...
public class InOutMigration extends AbstractModel implements MicroEventModel<MigrationEvent> {
    ...
    private final CreateCarOwnershipModelSP carOwnership;
    ...
    public InOutMigration(SiloDataContainer dataContainer, EmploymentModel employment, MovesModelI movesModel, CreateCarOwnershipModelSP carOwnership, DriversLicense driversLicense) {
        super(dataContainer);
