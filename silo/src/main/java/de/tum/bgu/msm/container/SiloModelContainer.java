...
import de.tum.bgu.msm.models.autoOwnership.CreateCarOwnershipModelSP;
...
public class SiloModelContainer {
    ...
    private final CreateCarOwnershipModelSP createCarOwnershipModel;
    ...
    private SiloModelContainer(InOutMigration iomig, ConstructionModel cons,
                               ...
                               CreateCarOwnershipModelSP createCarOwnershipModel, TransportModelI transportModel) {
        this.iomig = iomig;
        this.cons = cons;
    ...
    public static SiloModelContainer createSiloModelContainer(SiloDataContainer dataContainer, Config matsimConfig) {
        ...
        switch (Properties.get().main.implementation) {
            case MARYLAND:
                ...
                break;
            case MUNICH:
                createCarOwnershipModel = new CreateCarOwnershipModelSPImpl(dataContainer);
...
//        MarriageModel marriage = new DeferredAcceptanceMarriageModel(dataContainer, acc);
    ...
    public CreateCarOwnershipModelSP getCreateCarOwnershipModel() {
