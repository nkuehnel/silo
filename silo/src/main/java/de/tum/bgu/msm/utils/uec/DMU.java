...
public abstract class DMU implements com.pb.common.calculator2.VariableTable {
    ...
    public double getValueForIndex(int variableIndex, int arrayIndex) {
        ...
        try {
            ...
            try {
                Method method = this.getClass().getMethod(field, Integer.TYPE);
                return Double.parseDouble(String.valueOf(method.invoke(this, arrayIndex)));
