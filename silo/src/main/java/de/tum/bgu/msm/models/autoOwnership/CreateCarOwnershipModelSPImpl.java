...
public class CreateCarOwnershipModelSPImpl implements de.tum.bgu.msm.models.autoOwnership.CreateCarOwnershipModelSP {

    static Logger logger = Logger.getLogger(CreateCarOwnershipModelSPImpl.class);

    private TableDataSet zonalData;
    private final CreateCarOwnershipJSCalculator calculator;
    private final SiloDataContainer dataContainer;

    public CreateCarOwnershipModelSPImpl(SiloDataContainer dataContainer) {
