package syntheticPopulationGenerator.capeTown;
...
/*        } else if (incomeClass == 50) {
    ...
    private void addCars(boolean flagSkipCreationOfSPforDebugging) {
        ...
        CreateCarOwnershipModelSPImpl createCarOwnershipModelSP = new CreateCarOwnershipModelSPImpl(dataContainer);
        createCarOwnershipModelSP.run( );
    }
